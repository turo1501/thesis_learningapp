...
// Configure AWS SDK
aws_sdk_1.default.config.update(Object.assign({ region: process.env.AWS_REGION || 'us-east-2', accessKeyId: process.env.AWS_ACCESS_KEY_ID, secretAccessKey: process.env.AWS_SECRET_ACCESS_KEY }, (process.env.NODE_ENV !== "production" && {
        ...
        if (updateData.sections) {
            try {
                ...
                updateData.sections = sectionsData.map((section) => {
                    ...
                    return Object.assign(Object.assign({}, section), { sectionId: section.sectionId || (0, uuid_1.v4)(), sectionTitle: section.sectionTitle || "", sectionDescription: section.sectionDescription || "", chapters: section.chapters.map((chapter) => {
                            let videoValue = "";
                            if (chapter.video) {
                            ...
                            return Object.assign(Object.assign({}, chapter), { chapterId: chapter.chapterId || (0, uuid_1.v4)(), title: chapter.title || "", content: chapter.content || "", type: videoValue ? "Video" : "Text", video: videoValue });
                        }) });
                });
            }
            catch (error) {
...
const generateMockAIResponse = (topicTitle, difficultyLevel, courseLength) => __awaiter(void 0, void 0, void 0, function* () {
...
function generateWithDeepseek(prompt) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            console.error("Deepseek API error:", ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
            ...
            const errorData = {
                ...
                type: ((_g = (_f = (_e = error.response) === null || _e === void 0 ? void 0 : _e.data) === null || _f === void 0 ? void 0 : _f.error) === null || _g === void 0 ? void 0 : _g.type) || "api_error",
                code: ((_k = (_j = (_h = error.response) === null || _h === void 0 ? void 0 : _h.data) === null || _j === void 0 ? void 0 : _j.error) === null || _k === void 0 ? void 0 : _k.code) || "unknown_error"
            };
            // Check specifically for "Insufficient Balance" error
            if (((_o = (_m = (_l = error.response) === null || _l === void 0 ? void 0 : _l.data) === null || _m === void 0 ? void 0 : _m.error) === null || _o === void 0 ? void 0 : _o.message) === "Insufficient Balance") {
            ...
            else if (((_p = error.response) === null || _p === void 0 ? void 0 : _p.status) === 429) {
                errorData.code = "rate_limit_exceeded";
                errorData.message = "Deepseek API rate limit exceeded. Please try again later.";
            }
            else if (((_q = error.response) === null || _q === void 0 ? void 0 : _q.status) === 401 || ((_r = error.response) === null || _r === void 0 ? void 0 : _r.status) === 403) {
                errorData.code = "invalid_api_key";
                errorData.message = "Invalid Deepseek API key or insufficient permissions.";
            }
            else if (((_s = error.response) === null || _s === void 0 ? void 0 : _s.status) === 404) {
...
const fallbackToMockGenerator = (topicTitle, difficultyLevel, courseLength) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const mockContent = yield generateMockAIResponse(topicTitle, difficultyLevel, courseLength);
...
const trackAILearning = (input, output) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Create a learning directory if it doesn't exist
        const learningDir = path_1.default.join(__dirname, '../../ai-learning');
        if (!fs_1.default.existsSync(learningDir)) {
            fs_1.default.mkdirSync(learningDir, { recursive: true });
        }
        ...
        const filename = path_1.default.join(learningDir, `learning-${Date.now()}.json`);
        fs_1.default.writeFileSync(filename, JSON.stringify(learningEntry, null, 2));
...
const analyzeAndImproveAI = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const learningDir = path_1.default.join(__dirname, '../../ai-learning');
        if (!fs_1.default.existsSync(learningDir))
            return;
        const files = fs_1.default.readdirSync(learningDir).filter(f => f.startsWith('learning-'));
        if (files.length < 10)
        ...
        fs_1.default.writeFileSync(path_1.default.join(learningDir, 'ai-insights.json'), JSON.stringify(patternData, null, 2));
...
const loadAIInsights = () => {
    try {
        const insightsPath = path_1.default.join(__dirname, '../../ai-learning/ai-insights.json');
        if (fs_1.default.existsSync(insightsPath)) {
            const insights = JSON.parse(fs_1.default.readFileSync(insightsPath, 'utf8'));
            return insights;
        }
    }
    catch (error) {
...
const generateAICourse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { topicTitle, targetAudience, difficultyLevel, keyPoints, courseLength, teacherId, teacherName } = req.body;
        if (!topicTitle) {
        ...
        try {
            if (useMockData) {
                ...
                try {
                    generatedContent = yield generateMockAIResponse(topicTitle, difficultyLevel || "beginner", courseLength || "medium");
                }
                catch (mockError) {
        ...
        `;
                try {
                    ...
                    generatedContent = yield generateWithDeepseek(prompt);
                }
                catch (apiError) {
                    // Handle API errors
                    ...
                    if (isDevelopment) {
                        try {
                            ...
                            generatedContent = yield fallbackToMockGenerator(topicTitle, difficultyLevel || "beginner", courseLength || "medium");
            ...
            trackAILearning({
                ...
                chapterCount: generatedContent.sections.reduce((acc, s) => acc + s.chapters.length, 0)
            });
            res.json({
...
exports.generateAICourse = generateAICourse;
// Function to check Deepseek account status
const checkDeepseekStatus = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
